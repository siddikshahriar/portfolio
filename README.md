...
* **B.Sc. in Computer Science and Engineering (CSE)**
  * Leading University (Currently Studying)
* **Higher Secondary Certificate (HSC)**
  * Scholarshome (Passing Year: 2021)
...
### 1. Medic++
A comprehensive, large-scale healthcare platform designed to connect patients with medical services. 
* **Key Features:** Booking doctor appointments, calling ambulances with live Uber-like location tracking, and an integrated blood donor search system.
